...
function Vector (x, y) {
  ...
  this.from_name = function (s) {
    ...
    if (name == 'up') { return new Vector(0, 1) } else if (name == 'down') { return new Vector(0, -1) } else if (name == 'left') { return new Vector(-1, 0) } else if (name == 'right') { return new Vector(1, 0) }
    return null
  }
